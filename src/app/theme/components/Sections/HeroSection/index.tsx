...
import { THEME_TYPES } from '../../../../shared/constants/index'
...
const HeroSection: FC = () => {
	...
	return (
		...
		//links redes - about - years of experience - location
		<section className='w-full grid auto-rows-[172px] grid-cols-6 gap-4'>
			...
			>
				...
				<p className='text-sm w-full z-[1] opacity-70'>
