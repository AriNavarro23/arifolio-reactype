...
const ExperienceCard: FC<IExperienceCard> = ({
	...
	return (
		<motion.div
			...
			viewport={{ once: true }}
			className='row-span-1 col-span-8 lg:row-span-2 lg:col-span-2 bg-white dark:bg-raisin-black rounded-3xl overflow-hidden relative flex flex-col py-10 items-center justify-between'
		>
			<div className='flex flex-col items-center'>
				<img
					className={`w-40 h-20 object-contain z-[1] ${company_name}`}
					src={company_logo}
					alt={company_name}
				/>
